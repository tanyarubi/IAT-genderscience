			...
			questions:[
				{
					...
					name: 'iatresults',
					description: '' +
						'<p>The sorting test you just took is called the Implicit Association Test (IAT). You categorized Male and Female words with Science and Liberal Arts.</p>' +
						'<div class="jumbotron jumbotron-dark">' +
						  '<h2>Here is your result:</h2>' +
						  '<p><%= global.scienceiat.feedback %></p>' +
						'</div>' +

					    '<p>Your result is described as an "Automatic association for Male with Science and Female with Liberal Arts" if you were faster responding when <i>Science</i> and <i>Male</i> are assigned to the same response key than when <i>Science</i> and <i>Female</i> were classified with the same key. Your score is described as an "Automatic association for Female with Science and Male with Liberal Arts if the opposite occured.</p>' +
				...
				},
				{
					...
					answers: [
						...
						'Recommendation of a friend of co-worker',
						'Other'
					]
				},
				onFB,
